      ...
      <section className="flex relative flex-col justify-center items-start min-h-100v-h bg-blue-one px-[20px] pb-[75px] pt-[0px] md:p-[75px] overflow-hidden">
        {!loading ? (
          <>
            ...
            />
            <span
              className={`${style.btn1} absolute right-[20px] flex w-[152px] h-[132px] transition-all ease-linear duration-500 animate__animated animate__fadeInRight animate__delay-2s`}
            >
              <Link
